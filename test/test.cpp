...
void TestWindow::OnRender()
{
	...
	CHECK_D3D(m_pSwapChain->Present(m_oculusHMD ? 0 : 1, 0));
...
bool TestWindow::TryActivateVR()
{
	...
	MessageBox(m_hWnd, "No VR headset detected", "Couldn't activate VR", MB_OK);
	return false;
}
...
bool TestWindow::TryActivateOculusVR()
{
	...
	{
		MessageBox(m_hWnd, "Oculus VR headset is connected to a different GPU than the app is running on.", "Couldn't activate VR", MB_OK);
		return false;
	}
